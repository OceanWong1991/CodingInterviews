...
层次遍历的代码，我们前面已经将了很多了，这里就不再啰嗦了，需要的统计可以参见我的另外几篇博客 [二叉树的遍历详解（前序中序后序层次-递归和非递归）](http://blog.csdn.net/gatieme/article/details/51163010) [剑指Offer--023-从上往下打印二叉树（层次遍历二叉树）](http://blog.csdn.net/gatieme/article/details/51204976)
